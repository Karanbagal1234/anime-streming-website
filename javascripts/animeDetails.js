...
function updatePage(anime) {
    const selectors = {
        ...
        gern: "#main-content > div.informations > div.row > div:nth-child(1) > ul > li:nth-child(4)",
        score: "#main-content > div.informations > div.row > div:nth-child(2) > ul > li:nth-child(1)",
        rate: "#main-content > div.informations > div.row > div:nth-child(2) > ul > li:nth-child(2)",
    ...
    const updateElement = (selector, content) => {
        console.log(`selector is ${selector} and content is ${content}`)
    ...
    updateElement(selectors.gern, `<span>Genre:</span> ${anime.genre}`);
    updateElement(selectors.score, `<span>Scores:</span> ${anime.scores}`);
    updateElement(selectors.rate, `<span>Rating:</span> ${anime.rating}`);
